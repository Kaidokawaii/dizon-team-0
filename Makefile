<<<<<<< HEAD
a.out: kaiSystem.o kaiGraphics.o main.o ethan.o quennel.o quennel_screenSaver.o ethanProjec.o particle.h quennel_screenSaver.h ethanProjec.h
	g++ -g -fsanitize=address -std=c++23 main.o kaiSystem.o kaiGraphics.o ethan.o quennel.o quennel_screenSaver.o ethanProjec.o
